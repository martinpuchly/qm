...
ActiveRecord::Schema[7.1].define(version: 2024_01_10_210945) do
  create_table "material_types", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name"
    t.string "unit"
