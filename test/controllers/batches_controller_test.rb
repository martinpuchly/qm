...
class BatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create batch" do
    assert_difference("Batch.count") do
      post batches_url, params: { batch: { batchId: @batch.batchId, material_id: @batch.material_id, quantity: @batch.quantity, supplier_id: @batch.supplier_id } }
    end
  ...
  test "should update batch" do
    patch batch_url(@batch), params: { batch: { batchId: @batch.batchId, material_id: @batch.material_id, quantity: @batch.quantity, supplier_id: @batch.supplier_id } }
